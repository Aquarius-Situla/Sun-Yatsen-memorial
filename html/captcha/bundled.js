...
(() => {
  ...
  // react-stub.js
  var react_stub_default = window.React;
  var useState = window.React.useState;
  var useEffect = window.React.useEffect;
  var useContext = window.React.useContext;
  var useReducer = window.React.useReducer;
  var useCallback = window.React.useCallback;
  var useMemo = window.React.useMemo;
  var useRef = window.React.useRef;
  var useImperativeHandle = window.React.useImperativeHandle;
  var useLayoutEffect = window.React.useLayoutEffect;
  var useDebugValue = window.React.useDebugValue;
  var useDeferredValue = window.React.useDeferredValue;
  var useTransition = window.React.useTransition;
  var useId = window.React.useId;
  var useSyncExternalStore = window.React.useSyncExternalStore;
  var useInsertionEffect = window.React.useInsertionEffect;
  var createContext = window.React.createContext;
  var forwardRef = window.React.forwardRef;
  var memo = window.React.memo;
  var lazy = window.React.lazy;
  var Suspense = window.React.Suspense;
  var Fragment = window.React.Fragment;
  var Profiler = window.React.Profiler;
  var StrictMode = window.React.StrictMode;
  var Children = window.React.Children;
  var cloneElement = window.React.cloneElement;
  var createElement = window.React.createElement;
  var createFactory = window.React.createFactory;
  var isValidElement = window.React.isValidElement;
  var version = window.React.version;
  ...
  function ClawCaptcha({
    ...
    useEffect(() => {
      ...
      const step = (now2) => {
        const dtRaw = prevNow ? Math.min(0.04, Math.max(4e-3, (now2 - prevNow) / 1e3)) : 1 / 60;
        prevNow = now2;
        ...
        if (!reduce) {
          ...
          s.sway += s.swayV * f;
          s.breeze = Math.sin(now2 / 1500) * 0.45 + Math.sin(now2 / 521) * 0.12;
        }
          ...
          children: [
                  ...
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx("ol", { className: "clawcap-info-list", children: [
                        ["Move", /* @__PURE__ */ jsxs(Fragment2, { children: [
                          "Line the claw up right over your prize \u2014 joystick or ",
                          /* @__PURE__ */ jsx("kbd", { children: "\u2190" }),
                          " ",
                          /* @__PURE__ */ jsx("kbd", { children: "\u2192" })
                        ] })],
                        ["Grab", /* @__PURE__ */ jsxs(Fragment2, { children: [
                          "Commit. The claw dives, bites and hauls it up \u2014 red button or ",
                          /* @__PURE__ */ jsx("kbd", { children: "Space" })
                        ] })],
                        ["Drop", /* @__PURE__ */ jsx(Fragment2, { children: "Ferry it to the hatch and let go. Wrong toy? Straight back on the pile" })]
            ...
            /* @__PURE__ */ jsx("p", { className: "clawcap-sub", "aria-live": "polite", children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "wait", initial: false, children: /* @__PURE__ */ jsx(
              motion.span,
              {
                ...
                children: verified ? "You\u2019re human. Nice catch." : message ? message : /* @__PURE__ */ jsxs(Fragment2, { children: [
